...
Rails.application.configure do
  ...
  # Set RAILS_ASSUME_SSL=true in production with SSL proxy.
  config.assume_ssl = ENV.fetch("RAILS_ASSUME_SSL", "false") == "true"

  # Force all access to the app over SSL, use Strict-Transport-Security, and use secure cookies.
  # Set RAILS_FORCE_SSL=true in production with SSL.
  ...
  # SECURITY: Enable DNS rebinding protection and Host header attack prevention.
