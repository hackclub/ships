...
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name ships ships
...
# Install Node.js and pnpm for Vite
ARG NODE_VERSION=20
...
EXPOSE 8743
CMD ["./bin/rails", "server", "-b", "0.0.0.0", "-p", "8743"]
